            ...
            <div class="card-body fs-6 text-gray-700">
                ...
                <form method="POST" action="/users">
                    ...
                    <div class="form-group row mb-5">
                        ...
                        <div class="col-8">
                            <input required id="text3" name="email" placeholder="Email" type="text" class="form-control">
                        </div>
                        @if ($errors->has('email'))
                    ...
                    <div class="form-group row  mb-5">
                        ...
                        <div class="col-8">
                            <input id="text1" name="password" placeholder="Password" type="password" class="form-control" required="required">
                        </div>
                    ...
                    <div class="form-group row  mb-5">
                        ...
                        <div class="col-8">
                            <input id="text2" name="password_confirmation" placeholder="Password Confirmation" type="password" class="form-control" required="required">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <div class="form-control form-radio form-control-inline mb-5">
                                <input name="is_banned" id="is_banned_0" type="radio" class="form-check-input form-control-input" value="true" required="required">
                                <label for="is_banned_0" class="form-control-label">True</label>
                            </div>
                            <div class="form-control form-radio form-control-inline mb-5">
                                <input name="is_banned" id="is_banned_1" checked type="radio" class="form-check-input form-control-input" value="false" required="required">
